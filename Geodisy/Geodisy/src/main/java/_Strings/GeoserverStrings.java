...
public class GeoserverStrings {
    ...
    public static String SHP_2_PGSQL = "sudo shp2pgsql -d " + DATA_DIR_LOC;
    public static String PSQL_CALL = "| PGPASSWORD=" + POSTGIS_USER_PASSWORD +" psql -d ";
    ...
    public static String SHP_2_PGSQL_ALT(String encoding){
        return "sudo shp2pgsql -W \"" + encoding + "\" -d " + DATA_DIR_LOC;
    };

    public static void load(){
        SHP_2_PGSQL = "sudo shp2pgsql -d " + DATA_DIR_LOC;
    }

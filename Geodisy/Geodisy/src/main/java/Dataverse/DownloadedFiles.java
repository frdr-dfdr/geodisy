...
public class DownloadedFiles {
    ...
    public void addDownload(String fileName, String recordLabel, String url){
        String datetime = String.valueOf(ZonedDateTime.now(ZoneId.of("Canada/Pacific")));
        downloads.add("FileUrl=" + url + ";PersistantID=" + recordLabel + ";File Name=" + fileName + ";DateTime=" + datetime);
    }
